...
#ifndef POXCHAT_CFGFILES_H
#define POXCHAT_CFGFILES_H
...
int poxchat_open_file (const char *file, int flags, int mode, int xof_flags);
FILE *poxchat_fopen_file (const char *file, const char *mode, int xof_flags);
...
#define P_OFFSET(field) STRUCT_OFFSET_STR(struct poxchatprefs, field),sizeof(prefs.field)
#define P_OFFSETNL(field) STRUCT_OFFSET_STR(struct poxchatprefs, field)
#define P_OFFINT(field) STRUCT_OFFSET_INT(struct poxchatprefs, field),0
#define P_OFFINTNL(field) STRUCT_OFFSET_INT(struct poxchatprefs, field)
...
#define POXCHAT_SOUND_DIR "sounds"
