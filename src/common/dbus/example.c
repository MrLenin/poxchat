...
#define DBUS_SERVICE "org.poxchat.service"
#define DBUS_REMOTE "/org/poxchat/Remote"
#define DBUS_REMOTE_CONNECTION_INTERFACE "org.poxchat.connection"
#define DBUS_REMOTE_PLUGIN_INTERFACE "org.poxchat.plugin"
		 ...
		 gpointer user_data)
{
	...
	if (hook_id == command_id) {
		...
		/* Now if you write "/test blah" again in the PoxChat window
...
main (int argc, char **argv)
{
	...
	/* Now you can write on the PoxChat windows: "/test arg1 arg2 ..." */
